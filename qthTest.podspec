#
#  Be sure to run `pod spec lint qthTest.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "platypus333"
  # s.authors            = { "platypus333" => "qtinghao@163.com" }
  # s.social_media_url   = "http://twitter.com/platypus333"
